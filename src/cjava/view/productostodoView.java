 ...
 @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        tblProducto.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Cantidad", "Precio", "Stock"
            }
        ) {
 ...
 this.dispose();
    ...
    private void listaProductos()
    {
        ...
        try {
            ...
            List<ProductoDTO> lista = obj.ProductoListar(); //devuelve la lista de productos de la collections
            int nfilas=0;
        ...
        public void verProducto(List<ProductoDTO> lista)
                {
                DefaultTableModel tabla = (DefaultTableModel) tblProducto.getModel(); //devuelv eel modelo de la tabla
                tabla.setRowCount(0);//limpiar la tabla
                
                //FOR PARA MANEJO DE COLLECIONES
                    for (ProductoDTO p : lista) {
                        Object  []  datos= {p.getIdproducto(),p.getNombre(), p.getIdcategoria(),
